...
public class CreateLuaAuto
{
    ...
    public static void CreateLua()
    {
        ...
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0,
            ...
            GetSelectPathOrFallback() + "/NewLuaScript.lua", null,
            "Assets/GameMain/Scripts/Editor/TemplateScript/My LuaScript.txt");
    }
    ...
    public static void CreateEventCS()
    {
        ...
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0,
           ...
           GetSelectPathOrFallback() + "/NewCSharpScript.cs", null,
           "Assets/GameMain/Scripts/Editor/TemplateScript/My C#Script.txt");
    }
